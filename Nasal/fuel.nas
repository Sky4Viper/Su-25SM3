...
var fuelTanks = func {
	...
	var levelDropStbd2 = getprop("consumables/fuel/tank[6]/level-gal_us");
		if(levelDropStbd2 == nil) { levelDropStbd2 = 0; }
	var levelDropPort2 = getprop("consumables/fuel/tank[5]/level-gal_us");
		if(levelDropPort2 == nil) { levelDropPort2 = 0; }

	var levelWingStbd = getprop("consumables/fuel/tank[2]/level-gal_us");
		if(levelWingStbd == nil) { levelDropWingStbd = 0; }
	var levelWingPort = getprop("consumables/fuel/tank[3]/level-gal_us");
